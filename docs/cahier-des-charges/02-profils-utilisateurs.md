...
La section 1 a délimité le périmètre, application client et API pour applications d'agence
tierces et tchat de support. Cette section caractérise qui utilise le système et avec
...
> d'acceptation (par exemple un formulaire → `A11Y-FORMULAIRES` et `A11Y-CLAVIER`). C'est ce qui
