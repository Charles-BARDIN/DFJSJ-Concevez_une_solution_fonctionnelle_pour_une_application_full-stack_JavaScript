...
**Interopérabilité.** **REST + OAuth2 client-credentials** sont des **standards ubiquitaires** : des
...
**Interopérabilité.** **Webhooks HTTP signés** + **API REST** du prestataire = **protocole standard** ;
