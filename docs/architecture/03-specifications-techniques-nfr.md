...
| **Données** | **Base unifiée logiquement** (même schéma, même contrat ; **résidence régionale**, cf. ADR-020), modèle Ville–Agence–Offre et séparation données personnelles / transactionnelles posés au chapitre 6. | ADR-003 ; ADR-012 |
