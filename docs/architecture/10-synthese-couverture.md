...
|---|---|---|
| **Transverse** — documents rédigés clairs, structurés, **accessibles aux différents niveaux d'expertise et aux personnes en situation de handicap** (fiche, en-tête « Tous les documents rédigés ») | Transverse aux trois livrables — **L1 §1.1** (parties prenantes techniques **et** non techniques) ; **`NFR-A11Y-03`** (§7 du cahier des charges) ; **ch. 9 §9.3** | Hiérarchie de titres régulière + tableaux à en-têtes + **alternatives textuelles des 9 figures** (`NFR-A11Y-03`) ; **README destiné aux développeurs juniors** (livrable 3) ; lisibilité à plusieurs niveaux d'expertise |
